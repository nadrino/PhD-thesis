void Erec34_nH_250GC_phase-2_fit-crystalball_stacks-20_analysis_Data_vs_MC()
{
//=========Macro generated from canvas: canvas/canvas
//=========  (Thu Jun 13 10:38:13 2019) by ROOT version 6.13/02
   ...
   Target average1002->SetChisquare(106.5301);
   ...
   Target average1002->SetParameter(0,0.3099286);
   ...
   TText *ptstats_LaTex = ptstats->AddText("#chi^{2} / ndf = 106.5 / 5");
   ptstats_LaTex = ptstats->AddText("Prob  = 2.216e-21");
   ptstats_LaTex = ptstats->AddText("p0       = 0.3099 #pm 0.04681 ");
