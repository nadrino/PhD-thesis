void Erec34_nH_250GC_phase-2_fit-crystalball_stacks-20_analysis_Data_vs_MC_Mn_corrected()
{
//=========Macro generated from canvas: canvas/canvas
//=========  (Thu Jun 13 11:02:50 2019) by ROOT version 6.13/02
   ...
   Target average1002->SetChisquare(114.0273);
   ...
   Target average1002->SetParameter(0,1.094139);
   Target average1002->SetParError(0,0.04680979);
   ...
   TText *ptstats_LaTex = ptstats->AddText("#chi^{2} / ndf =   114 / 5");
   ptstats_LaTex = ptstats->AddText("Prob  = 5.768e-23");
   ptstats_LaTex = ptstats->AddText("p0       = 1.094 #pm 0.04681 ");
