void Mean_peak_Erec34_nH_250GC_phase-2_fit-crystalball_stacks-20_analysis()
{
//=========Macro generated from canvas: canvas/canvas
//=========  (Thu Jun 20 10:21:58 2019) by ROOT version 6.13/02
   ...
   gre->SetTitle("n-H peak monitoring with v34 / Phase-2");
   gre->SetFillColor(ci);
   ...
   TH1F *Graph_mean_peak_evolution_over_mean1001 = new TH1F("Graph_mean_peak_evolution_over_mean1001","n-H peak monitoring with v34 / Phase-2",100,1.504808e+09,1.56048e+09);
   ...
   pt->SetFillColor(0);
   pt->SetLineWidth(2);
   TText *pt_LaTex = pt->AddText("n-H peak monitoring with v34 / Phase-2");
   pt->Draw();
