void Calib_v34_Phase-1()
{
//=========Macro generated from canvas: c1/c1
//=========  (Wed Jun  5 11:47:05 2019) by ROOT version 6.13/02
   ...
   gre->SetTitle("Calibration Coefficient Evolution for Phase-1 (v34)");
   ...
   TH1F *Graph_CalibrationdOTGraphErrors1001 = new TH1F("Graph_CalibrationdOTGraphErrors1001","Calibration Coefficient Evolution for Phase-1 (v34)",100,1.480115e+09,1.489964e+09);
   ...
   pt->SetFillColor(0);
   pt->SetLineWidth(2);
   TText *pt_LaTex = pt->AddText("Calibration Coefficient Evolution for Phase-1 (v34)");
   pt->Draw();
